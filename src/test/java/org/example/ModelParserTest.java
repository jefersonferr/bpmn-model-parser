...
class ModelParserTest {
    ...
    void test01() {
        workflow = ModelParser.parser(new File("src/test/models/model_01.bpmn"));
        assertAll(
    ...
    void test05() {
        workflow = ModelParser.parser(new File("src/test/models/model_02.bpmn"));
        assertAll(
    ...
    void test06() {
        workflow = ModelParser.parser(new File("src/test/models/model_03.bpmn"));
        assertAll(
    ...
    void test09() {
        workflow = ModelParser.parser(new File("src/test/models/model_04.bpmn"));
        assertAll(
